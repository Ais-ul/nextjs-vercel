  ...
  return (
    <div id="noi" className="bg-[#2E2E2E] text-white py-12 px-4 md:py-16">
      <div className="max-w-4xl mx-auto text-center space-y-6">
        ...
        <h2 className="text-[#f59e0b] text-lg md:text-xl">Excellence in Catering, Perfection in Service</h2>

        <p className="text-gray-300 text-sm md:text-base leading-relaxed max-w-3xl mx-auto">
          La <span className="text-[#f59e0b]">Food Masters</span>, we elevate catering through premium ingredients, 
          innovative menus, and top-tier food safety standards. With <span className="text-[#f59e0b]">over 30 years of experience</span>, we provide customized meals for hospitals, 
        ...
        demand <span className="text-[#f59e0b]"> perfection on every plate</span>. </p>

        <div className="flex justify-center ">
          {[...Array(5)].map((_, i) => (
          <Star key={i} className="w-6 h-6 fill-[#f59e0b]" fill="currentColor" />
